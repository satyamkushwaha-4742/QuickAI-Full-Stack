...
//useUser() → Data layer (user details).
// useClerk() → Action layer (signOut, modals, redirects).
    const {user} = useUser();
    const {signOut, openUserProfile} = useClerk()
// isme nav items me mobile view taki ak select to baki  sidebar=false ho jayega 
  return (
